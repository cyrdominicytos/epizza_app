  ...
  (u = 864e5),
    ...
    (r = function (t) {
      ...
      for (t = t || {}, e = 1; e < arguments.length; e++)
        if ((n = arguments[e])) for (var a in n) n.hasOwnProperty(a) && ('object' == typeof n[a] ? r(t[a], n[a]) : (t[a] = n[a]));
      return t;
    }),
    (n = function (t, e) {
          ...
          switch (a) {
            ...
            case 2:
              if (
                ...
                (r = i.length),
                (d = 4 > r ? r : 4),
                (n = parseInt(4 > r ? n.toString().substr(0, 4 - r) + i : i.substr(0, 4))),
                !n)
              )
                return null;
              h.setFullYear(n);
                ...
                (r > 0 && e.charAt(r - 1) === c
                  ...
                  : ((u = s.parseFormat(i, t)),
                    r !== a - 1 &&
                      s.intParts.test(i) &&
                      'S' === e.charAt(r + 1) &&
                      ((n = parseInt(u) || 0), (u += s.dateSettings.ordinal(n))),
                    (o += u)));
          return o;
        }
        return '';
            ...
            if (percent > 1) {
              ...
              if (noTriggerScroll !== true) {
                timeboxparent.trigger('scroll_element.xdsoft_scroller', [
                  percentage || Math.abs(parseInt(timebox.css('marginTop'), 10)) / (height - parentHeight),
                ]);
              }
            }
          });
    ...
    createDateTimePicker = function (input) {
        ...
        .on('touchend mousedown.xdsoft', '.xdsoft_option', function () {
          if (!this.touchMoved) {
            ...
            if (_xdsoft_datetime && _xdsoft_datetime.currentTime) {
              _xdsoft_datetime.currentTime[$(this).parent().parent().hasClass('xdsoft_monthselect') ? 'setMonth' : 'setFullYear'](
                $(this).data('value')
              );
            }
      ...
      XDSoft_datetime = function () {
        ...
        _this.nextMonth = function () {
          ...
          _this.currentTime.setDate(
            Math.min(new Date(_this.currentTime.getFullYear(), month + 1, 0).getDate(), _this.currentTime.getDate())
          );
      ...
      timepicker.find('.xdsoft_prev,.xdsoft_next').on('touchend mousedown.xdsoft', function () {
        ...
        (function arguments_callee4(v) {
           ...
           */
          timeboxparent.trigger('scroll_element.xdsoft_scroller', [
            Math.abs(parseInt(timebox[0].style.marginTop, 10) / (height - pheight)),
          ]);
          ...
          xchangeTimer = setTimeout(function () {
            ...
            while (
              ...
              if (
                ...
                dateHelper.formatDate(_xdsoft_datetime.currentTime, options.formatDate) === dateHelper.formatDate(start, options.formatDate)
              ) {
              ...
              if (
                start.getDay() === 0 ||
                start.getDay() === 6 ||
                options.weekends.indexOf(dateHelper.formatDate(start, options.formatDate)) !== -1
              ) {
            ...
            month_picker
              ...
              .eq(1)
              .text(_xdsoft_datetime.currentTime.getFullYear() + options.yearOffset);
            ...
            if (options.minDateTime !== false) {
              ...
              var currentDayIsMinDateTimeDay =
                dateHelper.formatDate(_xdsoft_datetime.currentTime, options.formatDate) === dateHelper.formatDate(t, options.formatDate);
            ...
            line_time = function line_time(h, m) {
              ...
              if (
                (options.initTime || options.defaultSelect || datetimepicker.data('changed')) &&
            ...
            for (i = parseInt(options.yearStart, 10); i <= parseInt(options.yearEnd, 10); i += 1) {
              opt +=
                ...
                (_xdsoft_datetime.currentTime.getFullYear() === i ? 'xdsoft_current' : '') +
                '" data-value="' +
                i +
                '">' +
            ...
            for (i = parseInt(options.monthStart, 10), opt = ''; i <= parseInt(options.monthEnd, 10); i += 1) {
              opt +=
                '<div class="xdsoft_option ' +
                (_xdsoft_datetime.currentTime.getMonth() === i ? 'xdsoft_current' : '') +
                '" data-value="' +
                i +
                '">' +
      ...
      calendar.on('touchend click.xdsoft', 'td', function (xdevent) {
        ...
        datetimepicker.trigger('changedatetime.xdsoft');
        if (
          (timerclick > 1 || options.closeOnDateSelect === true || (options.closeOnDateSelect === false && !options.timepicker)) &&
          !options.inline
        ) {
          datetimepicker.trigger('close.xdsoft');
        }
        ...
        if ($.type(options.mask) === 'string') {
          ...
          input.on('keydown.xdsoft', function (event) {
            ...
            if ((key >= KEY0 && key <= KEY9) || (key >= _KEY0 && key <= _KEY9) || key === BACKSPACE || key === DEL) {
              ...
              if (
                ([AKEY, CKEY, VKEY, ZKEY, YKEY].indexOf(key) !== -1 && ctrlDown) ||
                [ESC, ARROWUP, ARROWDOWN, ARROWLEFT, ARROWRIGHT, F5, CTRLKEY, TAB, ENTER].indexOf(key) !== -1
              ) {
                return true;
              }
            }
