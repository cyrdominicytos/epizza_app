  ...
  each(['Width', 'Height'], function (v) {
    ...
    fn['outer' + v] = function (margins) {
      return (
        this[0]['offset' + v] +
        (margins
          ? compute(this, 'margin' + (v === 'Width' ? 'Left' : 'Top')) + compute(this, 'margin' + (v === 'Width' ? 'Right' : 'Bottom'))
          : 0)
      );
    };
  });
  ...
  var FloatingActionButton = (function (_Component14) {
    ...
    function FloatingActionButton(el, options) {
      ...
      var _this48 = _possibleConstructorReturn(
        this,
        (FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton)).call(this, FloatingActionButton, el, options)
      );
      ...
      [
        {
          key: 'init',
          value: function init(els, options) {
            return _get(FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton), 'init', this).call(
              this,
              this,
              els,
              options
      ...
      [
        ...
        },
        {
          ...
          value: function renderHead(opts) {
            ...
            for (i = 0; i < 7; i++) {
              arr.push(
                '<th scope="col"><abbr title="' + this.renderDayName(opts, i) + '">' + this.renderDayName(opts, i, true) + '</abbr></th>'
              );
            }
          ...
          value: function _handleCalendarClick(e) {
            ...
            if (!$target.hasClass('is-disabled')) {
              if ($target.hasClass('datepicker-day-button') && !$target.hasClass('is-empty') && !$target.parent().hasClass('is-disabled')) {
                this.setDate(
                  new Date(e.target.getAttribute('data-year'), e.target.getAttribute('data-month'), e.target.getAttribute('data-day'))
                );
  ...
  var CharacterCounter = (function (_Component17) {
    ...
    function CharacterCounter(el, options) {
      ...
      var _this61 = _possibleConstructorReturn(
        this,
        (CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter)).call(this, CharacterCounter, el, options)
      );
            ...
            for (i = 1; i <= half; ++i) {
              ...
              if (!this.noWrap || this.center + i < this.count) {
                ...
                var _transformString =
                  alignment + ' translateX(' + (this.options.shift + (this.dim * i - delta) / 2) + 'px) translateZ(' + zTranslation + 'px)';
