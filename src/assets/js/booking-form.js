...
$(document).ready(function () {
  ...
  $('.booking-form').submit(function (e) {
    ...
    var dataString =
      '&date=' + date.val() + '&name=' + name.val() + '&email=' + email.val() + '&phone=' + phone.val() + '&msg=' + msg.val();
    ...
    $.ajax({
      ...
      success: function (d) {
        ...
        else $('.loading').fadeIn('slow').html('<font color="#ff5607">Mail not sent.</font>').delay(3000).fadeOut('slow');
      },
    });
    return false;
  });
